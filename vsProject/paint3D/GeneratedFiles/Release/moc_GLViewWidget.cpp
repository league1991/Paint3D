...
void GLViewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData GLViewWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GLViewWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_GLViewWidget,
      qt_meta_data_GLViewWidget, &staticMetaObjectExtraData }
};
