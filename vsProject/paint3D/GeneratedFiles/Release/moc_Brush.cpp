...
static const char qt_meta_stringdata_PaintThread[] = {
    "PaintThread\0"
};
...
const QMetaObjectExtraData PaintThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PaintThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_PaintThread,
      qt_meta_data_PaintThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PaintThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PaintThread))
